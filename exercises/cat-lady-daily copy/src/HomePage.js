  ...
  return (
    <div className="homePage">
            ...
            <div  className="homeText">
                ...
                <hr/>
                <p className="p3">Click through the daily feline facts, choose your favorite cute captures, and watch the side bar as it displays your happiness slowly rising to cat lady nirvana.<span><img alt="arrow" src="https://static.thenounproject.com/png/1563369-200.png"></img></span></p>
            </div>
    </div>
  )
}
